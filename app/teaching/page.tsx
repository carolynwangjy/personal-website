...
const courses: CourseSection[] = [
    {
      ...
      subtitle: 'Course Website: [eecs189.org](https://eecs189.org)\nDisc Videos: [youtube.com/@cs189-sp26](https://www.youtube.com/@cs189-sp26/playlists)',
      columnHeaders: ['topic', 'video', 'pdfs'],
      materials: [
        {
          topic: 'disc01: math review',
        ...
        {
          topic: 'midterm (disc 01-07 content)',
          video: [{label: 'video', url: 'https://youtube.com/playlist?list=PL-ysCubq-Sa-oUudIQgL4uTjsiR-UWBlI&si=tBQFCHboT1jplM1m'}],
          pdfs: [{label: 'blank', url: 'https://drive.google.com/file/d/1KZFOxAYg4RYP_xzf5-OnjqVvZQ82Quw5/view?usp=drive_link'}, {label: 'solution', url: 'https://drive.google.com/file/d/1VCTJML71X_RZevsNpdsuy9IlFKl9QrxR/view?usp=drive_link'}],
        },
        {
...
export default function TeachingPage() {
  ...
  return (
    <section className="space-y-4 text-[var(--text-body)] leading-[1.45] text-neutral-800 dark:text-neutral-200 max-w-3xl">
      <h1 className="text-4xl font-semibold tracking-tight">teaching <span className="ml-1">🎓</span></h1>
