...
const courses: CourseSection[] = [
    {
      ...
      materials: [
        ...
        },        
        {
          ...
          pdfs: [{label: 'blank', url: 'https://drive.google.com/file/d/1Aa40Z2Ufa91YBNAlhfwsHG2JCT23T2SA/view'}, {label: 'solution', url: 'https://drive.google.com/file/d/16n2T86Vx2bneCubkQ7b52MV8c8wwFUyF/view'}, {label: 'notes', url: 'https://drive.google.com/file/d/16n2T86Vx2bneCubkQ7b52MV8c8wwFUyF/view'}],
        },
      ],
    },
    {
