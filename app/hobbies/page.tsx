...
export default function HobbiesPage() {
  ...
  return (
    <section className="space-y-4 text-[var(--text-body)] leading-[1.45] text-neutral-800 dark:text-neutral-200 max-w-3xl -mt-3">
      <h1 className="text-4xl font-semibold tracking-tight flex items-end">hobbies <span className="ml-2.5 text-[1.2em]" style={{ marginTop: '0.8rem' }}>☕</span></h1>
      <p className="text-neutral-700 dark:text-neutral-300">on a quest for more sidequests :D</p>
